#!/usr/bin/env python3
"""Gates: next-440 Phase 8 full designers (12)."""
from __future__ import annotations
import sys, unittest
from pathlib import Path
ROOT = Path(__file__).resolve().parents[3]
sys.path.insert(0, str(ROOT / "tools" / "map_generation" / "lib"))
from next440_phase8_designers import *  # noqa
...
class TestPackages(unittest.TestCase):
    def test_twelve(self):
        self.assertEqual(len(PHASE8_DESIGNERS_DAY_IDS), 12)
    ...
    def test_close(self):
        self.assertTrue(close_next440_phase8_designers_loop().get("ok"))
        self.assertTrue(phase8_designers_integrity().get("ok"))
...
class TestLive(unittest.TestCase):
    def test_wiring(self):
        ...
        for aid in PHASE8_DESIGNERS_DAY_IDS:
        ...
        self.assertIn("_next440_live_day", mm)
        self.assertIn("func _rebuild_phase8_designers_section", panel)
        self.assertIn("test_next12_phase8_designers_days.py", (ROOT / "tools/run_map_ci.sh").read_text())
        labels = [
            "designer module board day", "designer module edit day", "designer reliability gate day",
            "designer module editor close day", "designer stats board day", "designer freeze design day",
            "designer field seed day", "designer stats field close day", "designer catalog all domains day",
            "designer seed multi domain day", "designer equip campaign close day",
            "designer multi domain campaign close day", "next-440",
        ]
