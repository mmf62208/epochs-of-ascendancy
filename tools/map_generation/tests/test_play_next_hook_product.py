...
class TestPlayNextHookProduct(unittest.TestCase):
    ...
    def test_rank_beats_idle(self) -> None:
        ...
        world = rank_next_beat({"any_open_battle": True})
        self.assertEqual(world.get("source"), "land_battle")
        self.assertEqual(world.get("label"), "Open fight")
    ...
    def test_completing_bars_rank(self) -> None:
        ...
        self.assertEqual(choke_beats_cas.get("source"), "choke")
        self.assertEqual(choke_beats_cas.get("action"), "choke_flag")
    ...
    def test_maginot_chip_is_not_warloop(self) -> None:
        ...
        self.assertEqual(ready.get("action"), "open_fight")
        self.assertEqual(ready.get("from_id"), 710173)
        self.assertEqual(ready.get("to_id"), 710739)
        self.assertEqual(ready.get("fid"), "")
        idle = rank_next_beat({})
        self.assertEqual(idle.get("action"), "show_war_loop")
        self.assertEqual(idle.get("source"), "first_session")
