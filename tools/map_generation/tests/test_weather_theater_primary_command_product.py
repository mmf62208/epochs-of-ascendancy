...
from weather_theater_primary_command_product import (
    LIVE_API_BY_STEP, build_weather_theater_primary_command_product, close_weather_theater_primary_command_package, weather_theater_primary_command_integrity, primary_command_dead_audit,
)
...
class T(unittest.TestCase):
    ...
    def test_close_integrity(self):
        self.assertTrue(close_weather_theater_primary_command_package().get("ok"))
    ...
    def test_plain(self):
        p = build_weather_theater_primary_command_product(province_id=2)
