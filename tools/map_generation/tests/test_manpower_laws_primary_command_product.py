...
from manpower_laws_primary_command_product import (
    LIVE_API_BY_STEP, build_manpower_laws_primary_command_product, close_manpower_laws_primary_command_package, manpower_laws_primary_command_integrity, primary_command_dead_audit,
)
...
class T(unittest.TestCase):
    ...
    def test_close_integrity(self):
        self.assertTrue(close_manpower_laws_primary_command_package().get("ok"))
    ...
    def test_plain(self):
        p = build_manpower_laws_primary_command_product(province_id=2)
