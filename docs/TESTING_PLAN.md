...
- Province click → scrollable InfoPanel; Close/Esc keep Europe framed (no Greenland jump) and keep fills; left-drag pan must not pick; End shows Tokyo + Beiping/CHI star + China label
