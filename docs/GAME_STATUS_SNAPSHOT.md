...
| **GitHub** | `origin/main` @ `f825ad7` (B1–B6 living OOB / CHI–JAP / Channel / Maginot CAS / war-peace / AI take-land). Play branch `eoa/l1-war-loop-slice` matches. Do not force-push over June Cursor history. |
