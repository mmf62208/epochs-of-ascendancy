...
- **End key (playtest):** **first** press frames Tokyo + Beiping `902487` (no blank red hulls over Mongolia/China, no RUS West). While Asia End, hide **all** RoW `900000–949999` SOV/RUS/sov-red fills (no AABB); force CHI/MON/JAP/MAN/MEN opaque; dump leftover red pids; re-hide deferred after fit. Home restores RoW fills. Standalone Tokyo/Beiping stars unchanged. Leftover click skipped.
