...
- **Living unit counters (playtest):** DemoUnitIcon is a nation plate + NATO glyph + type letter + str% + designation + org/str/rdy bars (Polygon2D chrome, not the old dark retrowave square). Land infantry/armor/artillery stay NATO (retrowave 32s hid chrome). Pin-first when the chip is visible.
