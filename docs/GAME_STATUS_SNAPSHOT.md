...
**Date:** 2026-08-20 (L1 land loop + living units + organize + composition + industry TOE + **era resource harvest / develop-mine** · `--quick` green · board ~3520 · M6 human-only open)  
