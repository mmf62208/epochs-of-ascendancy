...
| **GitHub** | `origin/main` @ `acc1cb4` (B1–B4 living OOB / CHI–JAP / Channel / Maginot CAS). Play branch `eoa/l1-war-loop-slice` matches. Do not force-push over June Cursor history. |
