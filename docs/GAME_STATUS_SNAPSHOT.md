...
| **GitHub** | `origin/main` @ `525fbe7` (living unit counters: org/str/designation, pin-first over capital star). Play branch `eoa/l1-war-loop-slice` matches. Do not force-push over June Cursor history. |
