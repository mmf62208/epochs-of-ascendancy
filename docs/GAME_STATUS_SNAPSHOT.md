...
| Player↔map interconnect (Mike Layer 2) | **IX-1 Road Spine** — GER Rhineland `710416` Bonn–`710417` Köln–`710418` Leverkusen; inspector Build Road Spine → `build_road_connection` + RoadLayer + cheaper `get_movement_cost`; see [`IX1_ROAD_SPINE.md`](IX1_ROAD_SPINE.md) · HOLD merge |
