...
| **GitHub** | `origin/main` @ `90c4f5f` (B1–B7 living OOB / CHI–JAP / Channel / Maginot CAS / war-peace / AI take-land / nation-era-NEXT). Play branch `eoa/l1-war-loop-slice` matches. Do not force-push over June Cursor history. |
