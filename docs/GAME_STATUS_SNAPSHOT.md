...
**Date:** 2026-08-20 (L1 land loop + living units + organize + **composition + breakthrough/hardness combat** · `--quick` green · board ~3520 · M6 human-only open)  
...
- **L1 HOI-like attack/defend split (machine):** Composition **breakthrough** absorbs incoming fire on attack; **defense** on defend. **Hardness** mixes attacker soft vs hard against the target (`hardness_mix`). Headless: designed unit attack vs hard target **273** vs soft **299**. Designer shows Breakthrough / Hardness. Still not HOI numeric tables.
