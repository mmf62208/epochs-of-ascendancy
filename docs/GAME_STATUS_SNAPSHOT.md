...
| **GitHub** | `origin/main` @ `18e5f8b` (B1–B5 living OOB / CHI–JAP / Channel / Maginot CAS / war-peace). Play branch `eoa/l1-war-loop-slice` matches. Do not force-push over June Cursor history. |
